...
import { Card, CardContent, Grid, Button, Typography, InputAdornment, Box } from '@mui/material'
    ...
    <div>
      <div className='flex my-5'>
        <h1 className='text-[#232F6F] text-xl font-semibold flex items-center gap-2'>
          <span className='cursor-pointer flex items-center justify-center' onClick={() => router.push('/brand/list-brand')}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Grid item xs={12} className='flex justify-end gap-4 mt-6'>
          <Button
            ...
            color='secondary'
            onClick={() => reset()}
            sx={{ minWidth: 120, borderColor: '#63688B', color: '#63688B', backgroundColor: '#ECECF1' }}
          >
            Cancel
          </Button>

          <Button variant='contained' sx={{ minWidth: 120, backgroundColor: '#1171B2' }} type='submit'>
            Save
          </Button>
        </Grid>
      </form>
